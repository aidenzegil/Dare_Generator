    ...
    <div className="boxContainer">
      {HomeDivShown ? (
        <div id="HomeDiv" className="Container">
          ...
          <button onClick={DareAndPopup} className="GoBtn">
            {" "}
            GO!{" "}
          </button>
          <button className="SubmitDareBtn" onClick={divSwitch}>
            {" "}
            Submit Dare{" "}
          </button>
          {popupOpen && (
              ...
              content={
                <div className="container">
                  <div className="TextWrap">
                    <header className="GetDaredBro">
                      <i> I Dare You to </i>
                    </header>
                  </div>
                  <div className="TextWrap2">
                    <p className="DisplayedDare">{dare}</p>
                  </div>
                  <button className="NDBtn" onClick={readDare}>
                    {" "}
                    New Dare!{" "}
                  </button>
        ...
        <div id="SubmitPage" className="Container2">
          ...
          <input
            className="Input"
            maxLength={90}
            placeholder="Press submit when done =>"
            onChange={handleInput}
            value={newDare}
          />
          <button className="SubmitBtn" onClick={writeDare}>
            {" "}
            Submit{" "}
          </button>
          <button className="SubmitDareBtn" onClick={divSwitch}>
